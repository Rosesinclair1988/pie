...
$categoryAttributes = array(
    'mp_subcategories_mp' => array(
        'label' => 'Manual Placement',
        'input' => 'select',
        'type' => 'int',
        'source' => 'eav/entity_attribute_source_boolean',
        'frontend_input_renderer' => 'menuplus/adminhtml_helper_form_select',
        'note' => 'Replace Nb Categories per Columns with manual placement. Think to configure Change Column attribute in subcategories',
        'position' => 21,
    ),
    'mp_subcategories_mpcc' => array(
        'label' => 'Change Column',
        'input' => 'select',
        'type' => 'int',
        'source' => 'eav/entity_attribute_source_boolean',
